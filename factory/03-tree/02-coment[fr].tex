...
\newparaexample{Indiquer les valeurs d'une variable aléatoire}

Les commentaires permettent de faire facilement ce qui suit.

\inputlatexex{tikz/probatree-random-var.tkz}
\end{document}
